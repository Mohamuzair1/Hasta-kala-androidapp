...
import com.example.inventory.data.ColorSaleCount
import kotlinx.coroutines.flow.SharingStarted
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.stateIn

/**
 * ViewModel to retrieve sales data grouped by color for the dashboard.
 */
class BestSellerDashboardViewModel(
    private val craftsRepository: CraftsRepository
) : ViewModel() {

    val salesByColor: StateFlow<List<ColorSaleCount>> =
